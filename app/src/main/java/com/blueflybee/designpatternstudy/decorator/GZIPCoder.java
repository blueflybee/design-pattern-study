...
public class GZIPCoder extends CoderDecorator {
  ...
  public String write(String content) {
    try {
      String compressStr = new String(compress(content, UTF_8), ISO_8859_1);
//      String compressEncode = new BASE64Encoder().encode(compress(content));
  ...
  public String read(String content) {
    try {
      ...
      String uncompress = uncompressToString(content.getBytes(ISO_8859_1), UTF_8);
...
//    return uncompressToString(bytes, UTF_8);
//  }
